...
import { LayoutGrid, Cat, Sparkles, Trophy, AlertTriangle } from 'lucide-react';
		...
		<TooltipProvider delay={200}>
			<Sidebar collapsible="icon">
				<SidebarHeader>
					...
					>
						<div className="p-2 bg-accent-lime rounded-md">
							<Image
								src={logo}
								alt="Purrmanent logo"
								width={28}
					...
					<SidebarMenu>
						<SidebarMenuItem>
							<SidebarMenuButton
								...
								className="bg-danger text-on-primary font-bold uppercase tracking-[0.2px] shadow-emboss border hover:bg-danger/90 hover:text-on-dark-muted active:text-on-dark-faint active:bg-danger/90 transition-all duration-200 py-5"
							>
								<AlertTriangle />
								<span>Crisis</span>
							</SidebarMenuButton>
