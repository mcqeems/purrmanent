...
export function ReadinessSection() {
	return (
		<section
			id="readiness-checklists"
			className="bg-surface-canvas-light text-ink-deep"
		>
			<div className="mx-auto max-w-6xl px-6 border-b border-hairline-cloud py-24">
				<div className="grid md:grid-cols-3 gap-8 items-center mb-16">
					...
					{/*
						...
						"A hand-drawn pencil sketch and watercolor wash illustration of a cat scratching post, food bowl, water fountain, and a cat carrier bag grouped together, cozy organic look, white background, simple outline doodle. Purrmanent theme: accent lime #c2ef4e and violet #6a5fc1 as dominant tones, must work on dark #1f1633 and light #ffffff backgrounds --no 3d render, photorealistic"
					*/}
					<FadeInItem
						viewport={true}
						yOffset={20}
					...
					>
						<div className="w-full max-w-[300px] h-[240px] flex flex-col items-center justify-center p-4 scale-100 hover:scale-105 opacity-80 hover:opacity-100 transition-all duration-300">
							<Image
								src={catGearSetup}
								alt="Cat Setup Gear"
								width={300}
