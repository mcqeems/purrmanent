      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              'Points, your daily streak, and completion across all your cats.',
          },
        },
        {
          ...
          popover: {
            title: 'Your cats',
            description:
              'Open a cat to work its 90-day Kanban board and health log.',
          },
        },
        {
          ...
          popover: {
            title: 'Crisis mode',
            description:
              'Something wrong? Get an immediate, step-by-step protocol here.',
          },
        },
      ],
